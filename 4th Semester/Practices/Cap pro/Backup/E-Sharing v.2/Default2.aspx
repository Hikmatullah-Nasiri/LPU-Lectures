...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style=" margin-top: 30px;">
        ...
        <asp:DataList ID="DataList1" runat="server" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyField="ProductID" DataSourceID="SqlDataSource1" GridLines="Both" RepeatColumns="3" RepeatDirection="Horizontal">
                ...
                <table border="1" class="auto-style1">
                    ...
                    <tr>
                        <td>
                            ...
                            &nbsp;&nbsp;
                            <asp:Label ID="Label7" runat="server" Text="INR for 7 Days"></asp:Label>
                            &nbsp;<asp:Label ID="Label10" runat="server" Font-Bold="True" Text='<%# Eval("Discount") %>'></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl='<%# Eval("ProductDetails") %>'>Details</asp:LinkButton>
                        </td>
                    </tr>
                </table>
                <br />
